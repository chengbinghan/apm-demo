package com.hcb.asm.addfield;

import com.hcb.asm.remove.RemoveMethodAdapter;
...
public class AddAdapterTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        cw.visit(Opcodes.V1_5, Opcodes.ACC_PUBLIC + Opcodes.ACC_ABSTRACT + Opcodes.ACC_INTERFACE,
                "com/hcb/asm/generate/ComparableAdd", null, "java/lang/Object",
                null);
        ...
        //动态修改类名
        AddFieldAdapter ca = new AddFieldAdapter(cw2, Opcodes.ACC_PUBLIC + Opcodes.ACC_FINAL + Opcodes.ACC_STATIC, "FIELS_ADD_NAME", "I");
        cr.accept(ca, 0);
        byte[] b2 = cw2.toByteArray();


        //将上述生成的byts 写入一个XX.class 文件中，再通过一个反编译软件就可以看到生成的类。
        File file = new File("ComparableAdd.class");
