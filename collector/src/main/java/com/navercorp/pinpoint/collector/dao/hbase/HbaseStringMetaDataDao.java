...
import com.navercorp.pinpoint.collector.db.DBStringMetaDataDao;
...
public class HbaseStringMetaDataDao implements StringMetaDataDao {
    ...
    public void insert(TStringMetaData stringMetaData) {
      ...
      //  DBStringMetaDataDao dbStringMetaDataDao = new DBStringMetaDataDao();
       // dbStringMetaDataDao.insertStringMetaDataToDB(stringMetaData);
