...
/**
 * Device Pixel Ratio
 * @description https://developer.apple.com/library/safari/documentation/AudioVideo/Conceptual/HTML-canvas-guide/SettingUptheCanvas/SettingUptheCanvas.html
 */
...
(function() {
   ...
   * @description {@link http://fabricjs.com/events|Events demo}
   */
  fabric.Observable = {
    observe: observe,
...
(function() {
  ...
  if (!String.prototype.trim) {
     ...
     * @description <a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/String/Trim">String#trim on MDN</a>
     */
...
(function() {
  ...
  if (!Function.prototype.bind) {
     ...
     * @description <a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Function/bind">Function#bind on MDN</a>
...
(function(global) {
   ...
   * @field
   * @memberOf fabric.Color
   * @description: http://www.w3.org/TR/CSS2/syndata.html#color-units
   */
   ...
   * @return {Array} source
   * @description http://http://www.w3.org/TR/css3-color/#hsl-color
   */
...
(function() {
   ...
   * @description {@link fabric.Gradient#initialize} for constructor definition
   */
  ...
  fabric.util.object.extend(fabric.Gradient, {
     ...
     * @description http://www.w3.org/TR/SVG/pservers.html#LinearGradientElement
     * @description http://www.w3.org/TR/SVG/pservers.html#RadialGradientElement
     */
 ...
 * @description {@link http://fabricjs.com/patterns|Pattern demo}
 * @description {@link http://fabricjs.com/dynamic-patterns|DynamicPattern demo}
 * @description {@link fabric.Pattern#initialize} for constructor definition
 */
...
(function(global) {
   ...
   * Shadow class
   * @class fabric.Shadow
   * @description {@link http://fabricjs.com/shadows|Shadow demo}
   * @description {@link fabric.Shadow#initialize} for constructor definition
   */
  fabric.Shadow = fabric.util.createClass(/** @lends fabric.Shadow.prototype */ {
     ...
     * @description http://www.w3.org/TR/css-text-decor-3/#text-shadow
...
(function () {
   ...
   * @description {@link http://fabricjs.com/static_canvas|StaticCanvas demo}
   * @description {@link fabric.StaticCanvas#initialize} for constructor definition
   * @fires before:render
   * @fires after:render
  ...
  fabric.StaticCanvas = fabric.util.createClass(/** @lends fabric.StaticCanvas.prototype */ {
     ...
     * @chainable
     * @description {@link http://jsfiddle.net/fabricjs/MnzHT/|jsFiddle demo}
     ...
     * @return {fabric.Canvas} thisArg
     * @chainable
     * @description {@link http://jsfiddle.net/fabricjs/YH9yD/|jsFiddle demo}
     ...
     * @return {fabric.Canvas} thisArg
     * @chainable
     * @description {@link http://jsfiddle.net/fabricjs/pB55h/|jsFiddle demo}
     ...
     * @return {fabric.Canvas} thisArg
     * @chainable
     * @description {@link http://jsfiddle.net/fabricjs/hXzvk/|jsFiddle demo}
    ...
    /**
     * @private
     * @description {@link http://www.whatwg.org/specs/web-apps/current-work/multipage/the-canvas-element.html#dom-context-2d-imagesmoothingenabled|WhatWG Canvas Standard}
     */
     ...
     * @description {@link http://jsfiddle.net/fabricjs/jQ3ZZ/|jsFiddle demo}
   ...
   * @return {String} JSON string
   * @tutorial {@link http://fabricjs.com/fabric-intro-part-3#serialization}
   * @description {@link http://jsfiddle.net/fabricjs/pec86/|jsFiddle demo}
 ...
 * @description {@link http://fabricjs.com/freedrawing|Freedrawing demo}
 */
...
(function() {
   ...
   * @description {@link fabric.Canvas#initialize} for constructor definition
   *
  ...
  fabric.Canvas = fabric.util.createClass(fabric.StaticCanvas, /** @lends fabric.Canvas.prototype */ {
     ...
     * @description http://www.w3.org/TR/css3-ui/#cursor
     */
...
fabric.util.object.extend(fabric.StaticCanvas.prototype, /** @lends fabric.StaticCanvas.prototype */ {
   ...
   * @description {@link http://jsfiddle.net/fabricjs/NfZVb/|jsFiddle demo}
...
fabric.util.object.extend(fabric.StaticCanvas.prototype, /** @lends fabric.StaticCanvas.prototype */ {
   ...
   * @chainable
   * @tutorial {@link http://fabricjs.com/fabric-intro-part-3#deserialization}
   * @description {@link http://jsfiddle.net/fabricjs/fmgXt/|jsFiddle demo}
...
(function(global) {
   ...
   * @description {@link fabric.Object#initialize} for constructor definition
   *
   * @fires added
   * @fires removed
   *
  ...
  fabric.Object = fabric.util.createClass(/** @lends fabric.Object.prototype */ {
     ...
     * @return {fabric.Object} thisArg
     * @chainable
     * @description {@link http://jsfiddle.net/fabricjs/58y8b/|jsFiddle demo}
     ...
     * @return {fabric.Object} thisArg
     * @chainable
     * @description {@link http://jsfiddle.net/fabricjs/QT3pa/|jsFiddle demo}
     ...
     * @return {fabric.Object} thisArg
     * @chainable
     * @description {@link http://jsfiddle.net/fabricjs/7gvJG/|jsFiddle demo}
...
(function(global) {
   ...
   * @description {@link fabric.Line#initialize} for constructor definition
   */
   ...
   * @description http://www.w3.org/TR/SVG/shapes.html#LineElement
   */
...
(function(global) {
   ...
   * @class fabric.Circle
   * @extends fabric.Object
   * @description {@link fabric.Circle#initialize} for constructor definition
   */
   ...
   * @description: http://www.w3.org/TR/SVG/shapes.html#CircleElement
   */
...
(function(global) {
   ...
   * @description {@link fabric.Triangle#initialize} for constructor definition
   */
...
(function(global) {
   ...
   * @description {@link fabric.Ellipse#initialize} for constructor definition
   */
   ...
   * @description http://www.w3.org/TR/SVG/shapes.html#EllipseElement
   */
...
(function(global) {
   ...
   * @description {@link fabric.Rect#initialize} for constructor definition
   */
   ...
   * @description: http://www.w3.org/TR/SVG/shapes.html#RectElement
   */
...
(function(global) {
   ...
   * @extends fabric.Object
   * @description {@link fabric.Polyline#initialize} for constructor definition
   */
   ...
   * @description: http://www.w3.org/TR/SVG/shapes.html#PolylineElement
   */
...
(function(global) {
   ...
   * @extends fabric.Object
   * @description {@link fabric.Polygon#initialize} for constructor definition
   */
   ...
   * @description: http://www.w3.org/TR/SVG/shapes.html#PolygonElement
   */
...
(function(global) {
   ...
   * @description {@link fabric.Path#initialize} for constructor definition
   */
   ...
   * @static
   * @memberOf fabric.Path
   * @description http://www.w3.org/TR/SVG/paths.html#PathElement
   */
...
(function(global) {
   ...
   * @extends fabric.Path
   * @tutorial {@link http://fabricjs.com/fabric-intro-part-1#path_and_pathgroup}
   * @description {@link fabric.PathGroup#initialize} for constructor definition
   */
...
(function(global) {
   ...
   * @description {@link fabric.Group#initialize} for constructor definition
   */
...
(function(global) {
   ...
   * @description {@link fabric.Image#initialize} for constructor definition
   */
  fabric.Image = fabric.util.createClass(fabric.Object, /** @lends fabric.Image.prototype */ {
     ...
     * @description https://developer.mozilla.org/en-US/docs/HTML/CORS_settings_attributes
     * @type String
     * @default
     */
    crossOrigin: '',
     ...
     * @description http://www.w3.org/TR/SVG/coords.html#PreserveAspectRatioAttribute
   ...
   * @static
   * @description {@link http://www.w3.org/TR/SVG/struct.html#ImageElement}
   */
 ...
 * @description {@link http://fabricjs.com/image-filters|ImageFilters demo}
 */
...
(function(global) {
   ...
   * @description {@link fabric.Image.filters.Brightness#initialize} for constructor definition
   * @description {@link http://fabricjs.com/image-filters|ImageFilters demo}
   * @example
...
(function(global) {
   ...
   * @memberOf fabric.Image.filters
   * @extends fabric.Image.filters.BaseFilter
   * @description {@link fabric.Image.filters.Convolute#initialize} for constructor definition
   * @description {@link http://fabricjs.com/image-filters|ImageFilters demo}
...
(function(global) {
   ...
   * @memberOf fabric.Image.filters
   * @extends fabric.Image.filters.BaseFilter
   * @description {@link fabric.Image.filters.GradientTransparency#initialize} for constructor definition
   * @description {@link http://fabricjs.com/image-filters|ImageFilters demo}
   * @example
...
(function(global) {
   ...
   * @memberOf fabric.Image.filters
   * @extends fabric.Image.filters.BaseFilter
   * @description {@link fabric.Image.filters.Mask#initialize} for constructor definition
   */
...
(function(global) {
   ...
   * @memberOf fabric.Image.filters
   * @extends fabric.Image.filters.BaseFilter
   * @description {@link fabric.Image.filters.Noise#initialize} for constructor definition
   * @description {@link http://fabricjs.com/image-filters|ImageFilters demo}
   * @example
...
(function(global) {
   ...
   * @memberOf fabric.Image.filters
   * @extends fabric.Image.filters.BaseFilter
   * @description {@link fabric.Image.filters.Pixelate#initialize} for constructor definition
   * @description {@link http://fabricjs.com/image-filters|ImageFilters demo}
   * @example
...
(function(global) {
   ...
   * @memberOf fabric.Image.filters
   * @extends fabric.Image.filters.BaseFilter
   * @description {@link fabric.Image.filters.RemoveWhite#initialize} for constructor definition
   * @description {@link http://fabricjs.com/image-filters|ImageFilters demo}
   * @example
...
(function(global) {
   ...
   * @memberOf fabric.Image.filters
   * @extends fabric.Image.filters.BaseFilter
   * @description {@link fabric.Image.filters.Tint#initialize} for constructor definition
   * @description {@link http://fabricjs.com/image-filters|ImageFilters demo}
...
(function(global) {
   ...
   * @description {@link fabric.Text#initialize} for constructor definition
   */
   ...
   * @description: http://www.w3.org/TR/SVG/text.html#TextElement
   */
...
(function() {
   ...
   * @description {@link fabric.IText#initialize} for constructor definition
   *
...
(function(global) {
   ...
   * @description {@link fabric.Textbox#initialize} for constructor definition
   */
