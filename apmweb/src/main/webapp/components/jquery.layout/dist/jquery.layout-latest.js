...
,	getScrollbarSize:	function (dim) {
	...
	*
	* @description	$.swap() - swaps CSS, runs callback, resets CSS
...
,	showInvisibly: function ($E, force) {
	...
	*
	* @description  _create(), onWindowResize() for container, plus others for pane
...
,	getElementStyles: function ($E, list) {
	...
	*
	* @description  initPanes(), sizeMidPanes(), initHandles(), sizeHandles()
...
//			H -= (n($E, "paddingTop") + n($E, "paddingBottom"));
	...
	*
	* @description  Called by many methods
	* @param {Array.<Object>}	$E					Must pass a jQuery object - first element is processed
 ...
 */
	...
	*
	* @description  none - triggered onInit
...
,	_create = function () {
	...
	*
	* @description  All methods in Instance run this test
...
,	isInitialized = function () {
	...
	* Initialize the layout - called automatically whenever an instance of layout is created
	*
	* @description  _create() & isInitialized
...
,	_initContainer = function () {
	...
	*
	* @description  _create() and addPane()
...
,	initHandles = function (panes) {
	...
	*
	* @description  initPane() - or externally after an Ajax injection
	* @param {string}	pane			The pane to process
...
,	bindStartSlidingEvents = function (pane, enable) {
	...
	*
	* @description  slideOpen(), slideClose()
...
,	sizePane = function (evt_or_pane, size, skipCallback, noAnimation, force) {
	...
	/**
	* @description  initPanes(), sizePane(), 	resizeAll(), open(), close(), hide()
...
,	sizeMidPanes = function (panes, skipCallback, force) {
	...
	/**
	* @description  window.onresize(), callbacks or custom code
...
,	sizeContent = function (evt_or_panes, remeasure) {
	...
	*
	* @description  initHandles(), open(), close(), resizeAll()
	* @param {(string|Object)=}		evt_or_panes	The pane(s) being resized
	*/
...
,	swapPanes = function (evt_or_pane1, pane2) {
	...
	*
	* @description  open(), setAsOpen(), setAsClosed()
 ...
 *
 * @description: http://groups.google.com/group/jquery-ui-layout
 */
/*
...
,	encodeJSON: function (JSON) {
	 ...
	 *	@description		$.parseJSON(), adding in jQuery 1.4.1
	 */
