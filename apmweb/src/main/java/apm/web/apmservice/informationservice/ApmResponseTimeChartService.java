 ...
 */
@Service
public class ApmResponseTimeChartService implements ApmAgentStatChartService {

    private final SampledResponseTimeDao sampledResponseTimeDao;

    @Autowired
    public ApmResponseTimeChartService(@Qualifier("sampledResponseTimeDaoFactory") SampledResponseTimeDao sampledResponseTimeDao) {
