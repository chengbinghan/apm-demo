 ...
 */
@Service
public class ApmCpuLoadChartService implements ApmAgentStatChartService {

    private final SampledCpuLoadDao sampledCpuLoadDao;

    @Autowired
    public ApmCpuLoadChartService(@Qualifier("sampledCpuLoadDaoFactory") SampledCpuLoadDao sampledCpuLoadDao) {
