 ...
 */
@Service
public class ApmJvmGcChartService implements ApmAgentStatChartService {

    private final SampledJvmGcDao sampledJvmGcDao;

    @Autowired
    public ApmJvmGcChartService(@Qualifier("sampledJvmGcDaoFactory") SampledJvmGcDao sampledJvmGcDao) {
