 ...
 */
@Service
public class ApmDataSourceChartService implements ApmAgentStatChartService {
    ...
    @Autowired
    public ApmDataSourceChartService(@Qualifier("sampledDataSourceDaoFactory") SampledDataSourceDao sampledDataSourceDao) {
