 ...
 */
@Service
public class ApmJvmGcDetailedChartService implements ApmAgentStatChartService {

    private final SampledJvmGcDetailedDao sampledJvmGcDetailedDao;

    @Autowired
    public ApmJvmGcDetailedChartService(@Qualifier("sampledJvmGcDetailedDaoFactory") SampledJvmGcDetailedDao sampledJvmGcDetailedDao) {
