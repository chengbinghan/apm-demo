 ...
 */
@Service
public class ApmTransactionChartService implements ApmAgentStatChartService {

    private final SampledTransactionDao sampledTransactionDao;

    @Autowired
    public ApmTransactionChartService(@Qualifier("sampledTransactionDaoFactory") SampledTransactionDao sampledTransactionDao) {
