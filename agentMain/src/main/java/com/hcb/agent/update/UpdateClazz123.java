 ...
 * @description
 */
public class UpdateClazz123 {

    public static void main(String[] args) throws Exception {
        // 被监控jvm的pid(windows上可以通过任务管理器查看)
        String targetVmPid = "6436";
        // Attach到被监控的JVM进程上
        VirtualMachine virtualmachine = VirtualMachine.attach(targetVmPid);

        // 让JVM加载jmx Agent
        String javaHome = virtualmachine.getSystemProperties().getProperty("java.home");
        String agentPath = "C:\\kingdee\\study\\bytecode\\bytecode-workspace\\update-clazz\\agentMain\\target\\agentMain.jar";
