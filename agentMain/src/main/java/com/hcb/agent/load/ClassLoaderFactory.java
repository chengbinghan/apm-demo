    ...
    public static ClassLoader createClassLoader(File unpacked[],
        ...
        if (unpacked != null) {
            for (int i = 0; i < unpacked.length; i++)  {
                ...
                System.out.println("\"  Including directory \" + url");
    ...
    public static ClassLoader createClassLoader(List<Repository> repositories,
        ...
        if (repositories != null) {
            for (Repository repository : repositories)  {
                if (repository.getType() == RepositoryType.URL) {
                    ...
                    System.out.println("\"  Including URL \" + url");
                    set.add(url);
                    ...
                    System.out.println("\"  Including jar file \" + url");
                    set.add(url);
                    ...
                    System.out.println("\"  Including directory glob \"\n" +
                    ...
                    for (int j = 0; j < filenames.length; j++) {
                        ...
                        System.out.println("\"    Including glob jar file \"\n" +
        ...
        final URL[] array = set.toArray(new URL[set.size()]);
            ...
            for (int i = 0; i < array.length; i++) {
                System.out.println("  location " + i + " is " + array[i]);
            }
